...
<p align="center">
  A modern, centralized management system designed to streamline educational institution operations.  
  Efficiently manage <b>Departments</b>, <b>Students</b>, <b>Courses</b>, <b>Users</b>, and <b>Roles</b> in a user-friendly web interface.
</p>

<p align="center">
  <a href="https://academixx.runasp.net/" target="_blank">
...
The **Academix Management System** enables administrators to efficiently manage users, roles, courses, departments, and students — all within a secure, role-based platform.  
It’s a perfect learning project for mastering **ASP.NET Core MVC**, **Entity Framework Core**, and **Bootstrap integration**.  
...
<h3 align="center">⭐ If you found this project helpful, don’t forget to star the repo! 🌟</h3> 
